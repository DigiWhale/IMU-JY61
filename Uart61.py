...
def open_serial_connection_and_print_output():
    ...
    while True:
        ...
        reg_4 = data[8:10]
        checksum = data[10:11]
        checked = header_raw + b'5c'.hex() + sensor_raw + reg_1 + reg_2 + reg_3 + reg_4
        if sensor == b'51':
          ...
          print(header, header_raw, sensor, sensor_raw, dec_reg_1, dec_reg_2, dec_reg_3, dec_reg_4, checksum, dec_checksum, checked)
