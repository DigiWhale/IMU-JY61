...
def open_serial_connection_and_print_output():
    ...
    while True:
        ...
        if sensor == b'51':
          ...
          dec_checksum = int.from_bytes(checksum, byteorder=sys.byteorder, signed=True)
          print(header, sensor, dec_reg_1, dec_reg_2, dec_reg_3, dec_reg_4, checksum, dec_checksum)
