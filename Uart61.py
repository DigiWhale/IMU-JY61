...
def open_serial_connection_and_print_output():
    ...
    while True:
        ...
        reg_1 = literal_eval(str(binascii.hexlify(data[2:4]).decode('UTF-8')))
        reg_2 = literal_eval(str(binascii.hexlify(data[4:6]).decode('UTF-8')))
        reg_3 = literal_eval(str(binascii.hexlify(data[6:8]).decode('UTF-8')))
        reg_4 = literal_eval(str(binascii.hexlify(data[8:10]).decode('UTF-8')))
