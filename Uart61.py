...
def open_serial_connection_and_print_output():
    ...
    while True:
        ...
        if sensor == b'51':
          ...
          print('Acceleration', header, sensor, dec_reg_1, dec_reg_2, dec_reg_3, dec_reg_4, dec_checksum)
        elif sensor == b'52':
          ...
          dec_reg_4 = int.from_bytes(reg_4, byteorder=sys.byteorder, signed=True)/340+36.53
          dec_checksum = int.from_bytes(checksum, byteorder=sys.byteorder, signed=False)
          print('Velocity', header, sensor, dec_reg_1, dec_reg_2, dec_reg_3, dec_reg_4, dec_checksum)
        elif sensor == b'53':
          ...
          dec_reg_4 = int.from_bytes(reg_4, byteorder=sys.byteorder, signed=True)/340+36.53
          dec_checksum = int.from_bytes(checksum, byteorder=sys.byteorder, signed=False)
          print('Angle', header, sensor, dec_reg_1, dec_reg_2, dec_reg_3, dec_reg_4, dec_checksum)
        print('########################')
    ser.close()
    print('done')
