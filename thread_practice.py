...
while True:
    try:
        ...
        try:
          ...
          print('heading', round(heading), 'compass', round(compass[0][1]), 'imu_heading', round(imu_heading), 'imu_compensated', round((angle[2][1] + 360 if angle[2][1] < 0 else angle[2][1])), end='\r')
